...
public class Heliostat implements Serializable {
    ...
    public String eventCLToString() {
        ...
        switch (coupleBits3) {
            case 0x0:
                ...
                break;
            case 0x40:
                controlLocal.append("con fallo del micro esclavo");
                break;
            case 0x80:
                controlLocal.append("con fallo de batería");
                break;
        }
    ...
    public String diagnosisAz1ToString() {
        ...
        switch (coupleBits1) {
            case 0x0:
                ...
                break;
            case 0x4:
                diagnosisAz1.append("Fallo oscilación");
                break;
            case 0x8:
    ...
    public String toString() {
        return String.format("%s, operación %s, comunicación %s, control %s.", state0ToString(), eventOperationToString(), eventComToString(), eventCLToString());
    }

    public String diagnosisAZToString() {
        return String.format("Diagnóstico azimut: \n 1:%s \n 2:%s \n 3:%s \n 4:%s", diagnosisAz0ToString(), diagnosisAz1ToString(), diagnosisAz2ToString(), diagnosisAz3ToString());
    }

    public String diagnosisELToString() {
        return String.format("Diagnóstico elevación: \n 1:%s \n 2:%s \n 3:%s \n 4:%s", diagnosisEl0ToString(), diagnosisEl1ToString(), diagnosisEl2ToString(), diagnosisEl3ToString());
    }
}
